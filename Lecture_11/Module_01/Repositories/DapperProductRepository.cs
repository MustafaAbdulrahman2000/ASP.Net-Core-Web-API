...
public class DapperProductRepository(IDbConnection db)
{
    ...
    public async Task<bool> AddProductAsync(Product product, CancellationToken token = default)
    {
    ...
    public async Task<bool> AddProductReviewAsync(ProductReview review, CancellationToken token = default)
    {
    ...
    public async Task<bool> UpdateProductAsync(Product updatedProduct, CancellationToken token = default)
    {
        return await db.ExecuteAsync(""" 
